...
2. Sort the report in descending order by clicking on the drop-down next to the `Created Date`/`Create date` column header. This ensures the report is sorted consistently for export. 
